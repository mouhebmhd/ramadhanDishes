        ...
        <div class="search-bar-container col-md-8 col-sm-12">
          <div class="container-fluid d-flex">
            ...
            <div class="col m-1">
              <router-link
                v-bind:to="
                  '/getMealsByIngredient/' + searchQuery + '/' + dateQuery
                "
              >
                <input type="button" value="search" class="btn searchButton"
              /></router-link>
            </div>
          </div>
          <div
          ...
          <div
            ...
            id="receipes-suggestions"
          >
            <p class="recipesSuggestionTitle">All Receipes Suggestions</p>
            <div class="row flex-row flex-nowrap mealsList">
              <div
                class="col-3 meal m-2 p-0 d-flex flex-column"
                v-for="meal in meals"
...
export default {
  ...
  methods: {
    ...
    getAllMeals() {
      axios.get("http://localhost:3080/getAllMeals").then((response) => {
        this.meals = response.data;
      });
    },
    suggestedMeals() {
      axios.get("http://localhost:3080/SuggestedMeals/").then((response) => {
        this.suggestMeals = response.data;
      });
    },
  },
  mounted() {
